...
%I am unsure how do determine if two polygons are parent and child or siblings.
%checking orientation and interior at the rightmost point of the first completed polygon does not seem to be able to determine the relationship
